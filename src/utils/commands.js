...
let commandList = [
	...
	
	{
		...
		name:["tools"],
		action:true,
		response:"<div>Languages : JavaScript - TypeScript</div><div>Front-End : React, ReactNative, nextJS, HTML, CSS, TailWind, Bootstrap,mUI </div><div>Back-End : NodeJS - Express - Prisma</div> <div>Databases : MongoDB, Postgres, MySql</div> <div>Management Tools : Trello - Miro - Figma</div>",
		subPathStrict:[false],
